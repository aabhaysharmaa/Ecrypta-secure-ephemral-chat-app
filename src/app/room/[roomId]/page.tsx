...
const RoomId = () => {
	...
	const [timeRemaining, setTimeRemaining] = useState<number | null>(52);
		...
		<main className="flex flex-col h-screen max-h-screen overflow-hidden">
			...
			<div className="p-4 border-t border-zinc-800 bg-zinc900/30">
				<div className="flex gap-4">
					...
					<button className="bg-zinc-800 text-zinc-400 cursor-pointer hover:text-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed  px-6 text-sm font-bold">SEND</button>
				</div>
			</div>
		</main>
	)
